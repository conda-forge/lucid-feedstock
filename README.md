...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lucid-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9288&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lucid-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lucid` can be installed with:

```
conda install lucid
```

It is possible to list all of the versions of `lucid` available on your platform with:
